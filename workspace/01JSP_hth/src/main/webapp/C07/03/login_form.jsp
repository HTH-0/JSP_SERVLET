...
<% 
	...
	if(session.getAttribute("isAuth")!=null){
		out.println("<script>alert('이리 로그인 상태입니다.')</script>");
...
<form action="${pageContext.request.contextPath}/C07/03/login.jsp" method="post">
	...
	<div>
		<input type="checkbox" id = "saveID" name = "saveID"  ${cookie.idchk != null ? 'checked' : ''}/>
		<label for="saveID">ID 저장</label>
	</div>
	<div>
		<input type="checkbox" id = "savePW" name = "savePW"  ${cookie.pwchk != null ? 'checked' : ''}/>
